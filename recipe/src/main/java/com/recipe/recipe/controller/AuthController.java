...
public class AuthController {
    ...
    private String adminUsername; // Inject admin username from properties

    @Value("${admin.password}")
    private String adminPassword; // Inject admin password from properties
    ...
    public ResponseEntity<Map<String, String>> login(@RequestBody Map<String, String> body) {
        ...
        if (adminUsername.equals(email) && adminPassword.equals(password)) {
            ...
            System.out.println("Regular user login attempt.");
